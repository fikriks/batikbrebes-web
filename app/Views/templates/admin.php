...
<head>
  ...
  <title><?= $this->renderSection('title') ?> - Batik Tulis Brebes</title>
  <link rel="icon" type="image/png" href="/favicon-96x96.png" sizes="96x96" />
  <link rel="icon" type="image/svg+xml" href="/favicon.svg" />
  <link rel="shortcut icon" href="/favicon.ico" />
  <link rel="apple-touch-icon" sizes="180x180" href="/apple-touch-icon.png" />
  <meta name="apple-mobile-web-app-title" content="BATIKBREBES" />
...
<body>
  ...
  <div class="page-wrapper" id="main-wrapper" data-layout="vertical" data-navbarbg="skin6" data-sidebartype="full"
    ...
    <!--  Sidebar End -->
    <!--  Main wrapper -->
    <div class="body-wrapper d-flex flex-column min-vh-100 bg-light">
      <!--  Header Start -->
      ...
      <footer class="mt-auto py-4 text-center">
            <p class="mb-0">&copy; 2025 Gilang Subagio</p>
        </footer>
    </div>
  </div>
